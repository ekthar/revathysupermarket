export default function LoginLoading() {
  return (
    <main className="min-h-[calc(100vh-5rem)] px-4 py-6 sm:px-6 sm:py-10">
      <section className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="min-h-[420px] animate-pulse rounded-[2.25rem] bg-primary/20" />
        <div className="rounded-[2rem] border border-white/70 bg-card/95 p-5 shadow-soft">
