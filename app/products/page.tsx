...
export const metadata: Metadata = {
  ...
  description: "Search and order fresh groceries delivered to your door."
};
      ...
      <section className="overflow-hidden bg-[linear-gradient(135deg,rgba(15,138,95,0.12),rgba(167,209,41,0.14))] py-10 sm:py-14">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-6 text-muted-foreground sm:text-base">
            Live search, category filtering, price filtering, and delivery-ready products from your local store.
          </p>
        </div>
      </section>
