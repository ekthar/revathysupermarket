...
export default function PackingProfileScreen() {
    ...
    <AnimatedScreen className="flex-1 bg-white dark:bg-slate-950 px-5 pt-14">
      ...
      <AnimatedFadeIn>
        <View className="bg-slate-50 dark:bg-slate-900 rounded-2xl p-5 mb-6">
          ...
          <View className="mt-3 bg-purple-100 dark:bg-purple-900/30 self-start px-3 py-1 rounded-full">
            <Text className="text-xs font-bold text-purple-700 dark:text-purple-300">Packing Staff</Text>
          </View>
        </View>
      </AnimatedFadeIn>
