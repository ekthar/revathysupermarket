    ...
    <main className="flex min-h-dvh items-center justify-center bg-background px-4 py-10">
      <div className="w-full max-w-md">
        <div className="mb-6 text-center">
          ...
          <h1 className="mt-4 font-display text-2xl font-black text-foreground">Staff Login</h1>
          <p className="mt-1 text-sm text-muted-foreground">For admin, managers, and staff only</p>
