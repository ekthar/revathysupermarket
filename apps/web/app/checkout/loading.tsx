export default function CheckoutLoading() {
  return (
    <main className="mx-auto max-w-5xl px-4 py-8 sm:px-6 sm:py-10 lg:px-8">
      <section className="animate-pulse rounded-xl bg-primary/10 p-7">
      ...
      <div className="mt-6 grid gap-5 lg:grid-cols-[1fr_360px]">
        <div className="grid gap-5">
          {[1, 2, 3].map((item) => (
            <div key={item} className="animate-pulse rounded-xl border border-white/70 bg-card/95 p-5 shadow-soft">
        ...
        <div className="h-80 animate-pulse rounded-xl bg-muted shadow-soft" />
      </div>
    </main>
  );
}
