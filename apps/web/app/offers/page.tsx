    ...
    <main className="max-w-5xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
      ...
      {offers.length > 0 && (
        <section className="mt-6">
          <h2 className="text-lg font-bold text-slate-900 dark:text-white mb-4">Active Offers</h2>
      ...
      {promoCodes.length > 0 && (
        <section className="mt-8">
          <h2 className="text-lg font-bold text-slate-900 dark:text-white mb-4">Promo Codes</h2>
      ...
      {offers.length === 0 && promoCodes.length === 0 && (
        <div className="mt-12 text-center">
          <Tag className="h-12 w-12 text-slate-200 dark:text-slate-700 mx-auto" />
          <h2 className="mt-4 text-lg font-bold text-slate-900 dark:text-white">No offers right now</h2>
