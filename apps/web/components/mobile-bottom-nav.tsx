...
export const MobileBottomNav = memo(function MobileBottomNav({ user }: { user: SessionIdentity }) {
  ...
  if (["/login", "/welcome", "/forgot-password"].includes(pathname) || pathname.startsWith("/staff") || pathname.startsWith("/admin") || pathname.startsWith("/checkout") || pathname.startsWith("/delivery") || pathname.startsWith("/track")) return null;
