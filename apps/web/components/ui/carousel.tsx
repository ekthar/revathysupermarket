  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ref={ref}
        className={cn(
          "absolute left-2 top-1/2 -translate-y-1/2 z-10 h-9 w-9 rounded-full bg-white/90 dark:bg-neutral-800/90 shadow-md flex items-center justify-center transition-opacity disabled:opacity-0",
          className
        )}
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ref={ref}
        className={cn(
          "absolute right-2 top-1/2 -translate-y-1/2 z-10 h-9 w-9 rounded-full bg-white/90 dark:bg-neutral-800/90 shadow-md flex items-center justify-center transition-opacity disabled:opacity-0",
          className
        )}
