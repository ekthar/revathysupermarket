          ...
          {categories.slice(0, 6).map((cat) => (
            <motion.div key={cat} variants={itemVariants}>
              <Link
                ...
                className={`category-card category-card-animated ${categoryColors[cat] || "bg-slate-50 dark:bg-slate-800"} p-4 flex flex-col items-center justify-center gap-3 press`}
              >
