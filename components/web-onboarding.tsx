...
const STORAGE_KEY = "msm:onboarding-seen:v1";

const slides = [
  {
    icon: ShoppingBasket,
    title: "Fresh groceries in a few taps",
    text: "Browse MSM Supermarket like a mobile app, add essentials, and keep your cart ready across visits."
  },
  {
    icon: LocateFixed,
    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          <p className="mt-5 text-xs font-black uppercase tracking-wide text-lime-fresh">Welcome to MSM</p>
